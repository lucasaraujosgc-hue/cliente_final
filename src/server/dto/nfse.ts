...
export function nfseAtividadeAdminDTO(a: NfseAtividadeRow) {
  return {
    ...
    retCsll: a.retCsll,
    retInss: a.retInss,
    pisCofinsCst: a.pisCofinsCst ?? null,
    aliquotaPis: a.aliquotaPis,
    aliquotaCofins: a.aliquotaCofins,
    ibsCbsCst: a.ibsCbsCst ?? null,
    ibsCbsClassTrib: a.ibsCbsClassTrib ?? null,
    ibsCbsCindOp: a.ibsCbsCindOp ?? null,
    ibsCbsIndDest: a.ibsCbsIndDest,
    ativo: a.ativo,
    ordem: a.ordem,
  };
}
